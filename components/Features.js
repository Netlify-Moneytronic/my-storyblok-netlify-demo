      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blok.features?.map((nestedBlok) => (
            ...
            <>
              <div className="bg-gray-800 p-8 rounded-xl shadow-lg shadow-black/20 hover:shadow-xl transition-shadow duration-300 border border-gray-700">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">Experience blazing-fast performance that keeps your users engaged and your business moving forward.</p>
              </div>
              <div className="bg-gray-800 p-8 rounded-xl shadow-lg shadow-black/20 hover:shadow-xl transition-shadow duration-300 border border-gray-700">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">Built with enterprise-grade security and 99.9% uptime guarantee to keep your data safe and accessible.</p>
              </div>
              <div className="bg-gray-800 p-8 rounded-xl shadow-lg shadow-black/20 hover:shadow-xl transition-shadow duration-300 border border-gray-700">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">Intuitive interface designed for everyone, from beginners to experts. Get started in minutes, not hours.</p>
              </div>
            </>
          )}
        </div>
